...
UPDATE `football_weeks` SET `football_week_format_id` = 84 WHERE `id` IN (211, 216);  -- 3 Pools of 20 (60 players)
UPDATE `football_weeks` SET `football_week_format_id` = 85 WHERE `id` IN (212, 217);  -- 6 Pools of 10 (60 players)
UPDATE `football_weeks` SET `football_week_format_id` = 86 WHERE `id` IN (213);  -- 10 Pools of 6 (60 players)
UPDATE `football_weeks` SET `football_week_format_id` = 87 WHERE `id` IN (214);  -- Top 10 (60 players)
UPDATE `football_weeks` SET `football_week_format_id` = 88 WHERE `id` IN (215);  -- 2 Pools of 30 (60 players)
UPDATE `football_weeks` SET `football_week_format_id` = 89 WHERE `id` IN (218);  -- Top 15 (60 players)
...
UPDATE `football_weeks` SET `football_week_format_id` = 93 WHERE `id` IN (223, 224, 225, 226, 227, 228, 229, 231);  -- Top 8 (50 players)
