...
class VerifyEmail extends Snippet
{
	/**
	 * @param array $params
	 * @return string
	...
	public static function build(array $params = [])
	{
		...
		ob_start();
		?>
<p>Welcome to Pick55!</p>
<p>To complete the account creation process, please follow the link below to verify your email address.</p>
